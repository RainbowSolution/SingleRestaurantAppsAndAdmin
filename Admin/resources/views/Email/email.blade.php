                        ...
                        <div style="width:100%;max-width:580px;background:#ffffff;height:auto;padding:20px 0 0px 0">
                            ...
                            <div style="width:100%;max-width:580px;background:#ffffff;height:auto;padding:15px 0 0px 0">
                                <div bgcolor="#f8f4e8" align="left"
                                    ...
                                    Somebody (hopefully you) requested a new password for the account for {{$email}} <br>Your new password is<b>cscd <!-- {{$password}} --></b><br>Kindly update your password after login. We'll be here to help you with any step along the way
