...
class RattingFragment:BaseFragmnet() {
        ...
        val rattingAdapter = object : BaseAdaptor<RattingModel>(activity!!, rattingList) {
            override fun onBindData(
                ...
                if(rattingList.get(position).getRatting().equals("1")){
                    holder.itemView.ivRatting.setImageDrawable(activity!!.resources.getDrawable(R.drawable.ratting1))
                }else if(rattingList.get(position).getRatting().equals("2")){
                    holder.itemView.ivRatting.setImageDrawable(activity!!.resources.getDrawable(R.drawable.ratting2))
                }else if(rattingList.get(position).getRatting().equals("3")){
                    holder.itemView.ivRatting.setImageDrawable(activity!!.resources.getDrawable(R.drawable.ratting3))
                }else if(rattingList.get(position).getRatting().equals("4")){
                    holder.itemView.ivRatting.setImageDrawable(activity!!.resources.getDrawable(R.drawable.ratting4))
                }else if(rattingList.get(position).getRatting().equals("5")){
                    holder.itemView.ivRatting.setImageDrawable(activity!!.resources.getDrawable(R.drawable.ratting5))
                }
            }
    ...
    fun mWriteReviewDialog(act: Activity) {
        ...
        try {
            ...
            ivStar1.imageTintList = m_view.resources.getColorStateList(R.color.colorPrimary)
            ivStar2.imageTintList = m_view.resources.getColorStateList(R.color.gray)
            ivStar3.imageTintList = m_view.resources.getColorStateList(R.color.gray)
            ivStar4.imageTintList = m_view.resources.getColorStateList(R.color.gray)
            ivStar5.imageTintList = m_view.resources.getColorStateList(R.color.gray)
            ...
            ivStar2.setOnClickListener {
                ivStar1.imageTintList = m_view.resources.getColorStateList(R.color.colorPrimary)
                ivStar2.imageTintList = m_view.resources.getColorStateList(R.color.colorPrimary)
                ivStar3.imageTintList = m_view.resources.getColorStateList(R.color.gray)
                ivStar4.imageTintList = m_view.resources.getColorStateList(R.color.gray)
                ivStar5.imageTintList = m_view.resources.getColorStateList(R.color.gray)
                rattingValue=2;
            ...
            ivStar3.setOnClickListener {
                ivStar1.imageTintList = m_view.resources.getColorStateList(R.color.colorPrimary)
                ivStar2.imageTintList = m_view.resources.getColorStateList(R.color.colorPrimary)
                ivStar3.imageTintList = m_view.resources.getColorStateList(R.color.colorPrimary)
                ivStar4.imageTintList = m_view.resources.getColorStateList(R.color.gray)
                ivStar5.imageTintList = m_view.resources.getColorStateList(R.color.gray)
                rattingValue=3;
            }
            ivStar4.setOnClickListener {
                ...
                ivStar2.imageTintList = m_view.resources.getColorStateList(R.color.colorPrimary)
                ivStar3.imageTintList = m_view.resources.getColorStateList(R.color.colorPrimary)
                ivStar4.imageTintList = m_view.resources.getColorStateList(R.color.colorPrimary)
                ivStar5.imageTintList = m_view.resources.getColorStateList(R.color.gray)
                rattingValue=4;
            }
            ivStar5.setOnClickListener {
                ...
                ivStar3.imageTintList = m_view.resources.getColorStateList(R.color.colorPrimary)
                ivStar4.imageTintList = m_view.resources.getColorStateList(R.color.colorPrimary)
                ivStar5.imageTintList = m_view.resources.getColorStateList(R.color.colorPrimary)
                rattingValue=5;
            }
                ...
                if (response.code() == 200) {
                 //   dismissLoadingProgress()
                    ...
                    if (restResponce.getStatus().equals("1")) {
                       ...
                       /* val rattingModel=RattingModel()
                        rattingModel.setName(getStringPref(activity!!,SharePreference.userName))
                        rattingModel.setComment(discription)
                        rattingModel.setRatting(rattingValue)
                        rattingModel.setCreated_at(formattedDate)
